...
ระบบนี้มีข้อจำกัดและข้อกำหนดในการใช้งานทั่วไปดังนี้ เพื่อรักษาประสิทธิภาพและการทำงานของแอปพลิเคชันให้เสถียรที่สุด:

### 1. ข้อจำกัดด้านรูปภาพ (Image Specifications & Limitations)
...
* **รูปภาพหน้าปก (Cover Image):** กำหนดให้อัปโหลดได้ **1 รูป** ต่อหนึ่งบทความ
...
### 2. ข้อจำกัดฟิลด์ข้อมูลบทความ (Blog Post Field Validations)
...
### 3. ระบบความคิดเห็น (Comment System)
* **การคัดกรองเนื้อหาความคิดเห็น (Moderation):** ทุกๆ ความคิดเห็นที่ถูกส่งเข้ามาจากผู้เข้าชมหน้าบ้านจะถูกตั้งสถานะเริ่มต้นเป็น `pending` (รอตรวจสอบ) เสมอ โดยจะยังไม่แสดงบนหน้าเว็บหลักจนกว่าผู้ดูแลระบบ (Admin) จะเข้ามากดยอมรับเพื่ออนุมัติสิทธิ์การเผยแพร่เป็น `approved` หรือกดปฏิเสธ `rejected` เพื่อลบออกจากระบบหลังบ้าน
