...
| **File Upload / UX** | **react-dropzone** | ไลบรารีสำหรับจัดการระบบลากและวางรูปภาพ (Drag & Drop) เพื่อใช้อัปโหลดรูปปกและรูปภาพแกลเลอรีประกอบบทความ มีระบบจัดการสถานะลากและพรีวิวที่รวดเร็วลื่นไหล |
...
* **รูปภาพประกอบบทความ (Gallery / Extra Images):** รองรับการอัปโหลดไฟล์รูปภาพเพิ่มเติมได้สูงสุดไม่เกิน **6 รูป** ต่อหนึ่งบทความ 
...
* **ชื่อบทความ (Title):** จำเป็นต้องกรอกข้อมูล (Required)
* **เรื่องย่อ/สรุปย่อบทความ (Summary):** จำเป็นต้องกรอกข้อมูล และจำกัดความยาวสูงสุด**ไม่เกิน 300 ตัวอักษร** (`maxLength: 300`)
...
* **ข้อความต้องเป็นภาษาไทยและตัวเลขเท่านั้น:** validate backend ผ่าน zod
